...
# Article-style (modern layout) variant of the MarketSpark case study, kept
# alongside the immersive version (content/case-studies/marketspark.md) for
# comparison. No `layout:` override → uses the modern single.html layout.
