...
Those early Terraform patterns were replicated at machine speed as engineers dogfooded Cursor. They were copied and instantiated hundreds of times without the architectural guardrails needed to keep the system manageable. The result was a classic [terralith](https://masterpoint.io/blog/terralith-monolithic-terraform-architecture/): critical infrastructure was managed as a single [monolithic production Terraform workspace](https://masterpoint.io/blog/terralith-monolithic-terraform-architecture/) with over 7,000 resources in one state file.
