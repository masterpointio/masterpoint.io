---
title: "Template Preview · Every Case-Study Shortcode in One Page"
draft: true   # excluded from production; run `hugo serve -D` locally to preview
description: "Living template / shortcode gallery for the case-study layout. Use this page to preview each cs-* shortcode and copy-paste boilerplate when starting a new case study."
...
## A Section H2 (eligible for any future TOC)
