...
<div style="margin:2rem 0; padding:1.25rem 1.5rem; background:#f6faf7; border:1px solid #d6e6d8; border-left:4px solid #00a4a4; border-radius:0 10px 10px 0;">
  ...
  <div style="color:#333;">The fix usually involves nontrivial engineering work with real blast radius, which is too big of a commitment to make on circumstantial evidence. The exclude flag lets you test that hypothesis in minutes and gives you the hard evidence to justify the work, without changing a line of code or any possibility of affecting real infrastructure.</div>
</div>
